<%@ Page Language="C#" ClassName="EventCalendarDayView.aspx" Inherits="System.Web.UI.Page"   %>
...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("Location", siteRoot + "/EventCalendar/DayView.aspx?pageid=" 
            + pageId.ToString(CultureInfo.InvariantCulture)
            + "&mid=" + moduleId.ToString(CultureInfo.InvariantCulture)
            + "&date=" + Server.UrlEncode(theDate.ToString("s"))
            );
...
<head id="Head1" runat="server">
    <title>EventCalendarDayView</title> 
</head>
<body>
