...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
    ...
    <asp:HyperLink ID="lnkMemberList" runat="server"  />
    </div>
    <mp:CornerRounderTop ID="ctop1" runat="server" />
    <asp:Panel ID="pnlUserProfile" runat="server" DefaultButton="btnUpdate" CssClass="panelwrapper admin manageusers">
        <div class="modulecontent">
            <fieldset>
                ...
                <div id="divtabs" class="mojo-tabs">
                        ...
                        <div id="tabProfile" runat="server">
                            <div id="divAvatarUrl" runat="server" >
                                ...
                                <mp:SiteLabel ID="lblAvatar" runat="server" ForControl="ddAvatars" CssClass="settinglabel"
                                    ConfigKey="UserProfileAvatarLabel"></mp:SiteLabel>
                                <portal:Gravatar ID="gravatar1" runat="server" CssClass="forminput" />
                                </div>
                                <div class="settingrow">
                    ...
                    <div class="settingrow">
                        <asp:ValidationSummary ID="vSummary" runat="server" CssClass="txterror" ValidationGroup="profile"></asp:ValidationSummary>
                        ...
                        <asp:RegularExpressionValidator ID="regexEmail" runat="server" ControlToValidate="txtEmail"
                            Display="None" ValidationGroup="profile" ValidationExpression="^([a-zA-Z0-9_\-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([a-zA-Z0-9\-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$"></asp:RegularExpressionValidator>
