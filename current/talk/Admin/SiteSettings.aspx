...
<div class="breadcrumbs">
        ...
        <asp:HyperLink ID="lnkSiteList" runat="server" NavigateUrl="~/Admin/AdminMenu.aspx"
            CssClass="unselectedcrumb" /><asp:Literal id="litSiteListLinkSeparator" runat="server" Text="&nbsp;&gt;" />
        <asp:HyperLink ID="lnkSiteSettings" runat="server" CssClass="selectedcrumb" />
    </div>
    <mp:CornerRounderTop ID="ctop1" runat="server" />
    <asp:Panel ID="pnlSiteSettings" runat="server" DefaultButton="btnSave" CssClass="panelwrapper admin sitesettings">
        <div class="modulecontent">
            <fieldset>
                <legend>
                    <asp:Literal id="litLegend" runat="server" />
                </legend>
                ...
                <div id="divtabs" class="mojo-tabs">
                    <ul>
                        ...
                        <div id="tabSettings">
                            ...
                            <div class="settingrow">
                                <mp:SiteLabel ID="Sitelabel85" runat="server" ForControl="chkAllowUserSkins" CssClass="settinglabel"
                                    ...
                                    <div id="tabGeneralSecurity" runat="server">
                                        <asp:Panel ID="pnlUserSecurity" runat="server" SkinID="plain">
                                            <div id="divSiteIsClosed" runat="server" class="settingrow">
                                                <mp:SiteLabel ID="Sitelabel102" runat="server" ForControl="chkAllowRegistration" CssClass="settinglabel"
                                                    ConfigKey="SiteIsClosed" />
                                                <asp:CheckBox ID="chkSiteIsClosed" runat="server" TabIndex="10" CssClass="forminput" />
                            ...
                            <asp:UpdatePanel ID="upHosts" UpdateMode="Conditional" runat="server">
                                <ContentTemplate>
                                    <asp:Panel ID="pnlHostNames" runat="server" DefaultButton="btnAddHost">
                                        ...
                                        <br />
                                        <br />
                                        <portal:mojoLabel ID="lblHostMessage" runat="server" CssClass="txterror" EnableViewState="false" />
                                    </asp:Panel>
                                    <h3>
                            ...
                            <asp:UpdatePanel ID="upFolderNames" UpdateMode="Conditional" runat="server">
                                <ContentTemplate>
                                    <asp:Panel ID="pnlAddFolder" runat="server" DefaultButton="btnAddFolder">
                                        ...
                                        <br />
                                        <br />
                                        <portal:mojoLabel ID="lblFolderMessage" runat="server" CssClass="txterror" />
                                    </asp:Panel>
                                    <h3>
                ...
                <div class="settingrow">
                    ...
                    <portal:mojoLabel ID="lblErrorMessage" runat="server" CssClass="txterror" EnableViewState="false"></portal:mojoLabel>
