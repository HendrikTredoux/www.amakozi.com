...
<fieldset id="pnlExistingSettings" runat="server" class="moduledefinitionsettings">
   ...
   <asp:HyperLink ID="lnkAdminMenu" runat="server" NavigateUrl="~/Admin/AdminMenu.aspx" />&nbsp;&gt;
    ...
    <mp:SiteLabel id="lbl1" runat="server" ConfigKey="ModuleDefinitionsSettingsLabel"></mp:SiteLabel>
   </legend>
        ...
        <asp:TemplateField HeaderText="">
            ...
            <EditItemTemplate>
                <div class="settingrow">
                    <mp:SiteLabel id="SiteLabel9" runat="server" ForControl="txtResourceFile" ConfigKey="ModuleDefinitionsResourceFileLabel" CssClass="settinglabel"></mp:SiteLabel>
                    <asp:TextBox ID="txtResourceFile" Text='<%# Bind("ResourceFile")%>' runat="server" MaxLength="255" Columns="60" CssClass="forminput" />
                 </div>
                 <div class="settingrow">
                    <mp:SiteLabel id="SiteLabel15" runat="server" ForControl="txtGroupNameKey" ConfigKey="ModuleDefinitionsGroupNameLabel" CssClass="settinglabel"></mp:SiteLabel>
                    <asp:TextBox ID="txtGroupNameKey" Text='<%# Bind("GroupName")%>' runat="server" MaxLength="255" Columns="60" CssClass="forminput" />
                 </div>
                 <div class="settingrow">
                    <mp:SiteLabel id="lbl1" runat="server" ForControl="txtSettingName" ConfigKey="ModuleDefinitionsSettingNameLabel" CssClass="settinglabel"></mp:SiteLabel>
                    <asp:TextBox ID="txtSettingName" Text='<%# Bind("SettingName")%>' runat="server" MaxLength="255" Columns="60" CssClass="forminput" />
                 </div>
                 <div class="settingrow">
                    <mp:SiteLabel id="SiteLabel2" runat="server" ForControl="ddControlType" ConfigKey="ModuleDefinitionsSettingControlTypeLabel" CssClass="settinglabel"></mp:SiteLabel>
                ...
                <div class="settingrow">
                    <mp:SiteLabel id="SiteLabel3" runat="server" ForControl="txtControlSrc" ConfigKey="ModuleDefinitionsSettingControlSrcLabel" CssClass="settinglabel"></mp:SiteLabel>
                    <asp:TextBox ID="txtControlSrc" runat="server" Text='<%# Bind("ControlSrc")%>' MaxLength="255" Columns="60" CssClass="forminput" />
               </div>
                <div class="settingrow">
                    <mp:SiteLabel id="SiteLabel33" runat="server" ForControl="txtSettingValue" ConfigKey="ModuleDefinitionsSettingValueLabel" CssClass="settinglabel"></mp:SiteLabel>
                    <asp:TextBox ID="txtSettingValue" runat="server" Text='<%# Bind("SettingValue")%>' MaxLength="255" Columns="60" CssClass="forminput" />
               </div>
               <div class="settingrow">
                    <mp:SiteLabel id="SiteLabel10" runat="server" ForControl="txtSortOrder" ConfigKey="ModuleDefinitionsSettingSortOrderLabel" CssClass="settinglabel"></mp:SiteLabel>
                    <asp:TextBox ID="txtSortOrder" runat="server" Text='<%# Bind("SortOrder")%>' MaxLength="255" Columns="60" CssClass="forminput" />
               </div>
               <div class="settingrow">
                    <mp:SiteLabel id="SiteLabel12" runat="server" ForControl="txtHelpKey" ConfigKey="ModuleDefinitionsSettingHelpKeyLabel" CssClass="settinglabel"></mp:SiteLabel>
                    <asp:TextBox ID="txtHelpKey" runat="server" Text='<%# Bind("HelpKey")%>' MaxLength="255" Columns="60" CssClass="forminput" />
               </div>
               <div class="settingrow">
                    <mp:SiteLabel id="SiteLabel4" runat="server" ConfigKey="ModuleDefinitionsSettingRegexExpressionLabel" CssClass="settinglabel"></mp:SiteLabel>
...
<fieldset>
    <legend>
        <mp:SiteLabel id="SiteLabel1" runat="server" ConfigKey="ModuleDefinitionsAddSettingHeader"></mp:SiteLabel>
    </legend>
    <div class="settingrow">
        <mp:SiteLabel id="SiteLabel9" runat="server" ForControl="txtNewResourceFile" ConfigKey="ModuleDefinitionsResourceFileLabel" CssClass="settinglabel"></mp:SiteLabel>
        <asp:TextBox ID="txtNewResourceFile" Text='<%# Bind("ResourceFile")%>' runat="server" MaxLength="255" Columns="60" CssClass="forminput" />
    </div>
    <div class="settingrow">
        <mp:SiteLabel id="SiteLabel14" runat="server" ForControl="txtGroupNameKey" ConfigKey="ModuleDefinitionsGroupNameLabel" CssClass="settinglabel"></mp:SiteLabel>
        <asp:TextBox ID="txtGroupNameKey" runat="server" MaxLength="255" Columns="60" CssClass="forminput" />
   </div>
    <div class="settingrow">
        <mp:SiteLabel id="SiteLabel5" runat="server" ForControl="txtNewSettingName" ConfigKey="ModuleDefinitionsSettingNameLabel" CssClass="settinglabel"></mp:SiteLabel>
        <asp:TextBox ID="txtNewSettingName" runat="server" MaxLength="255" Columns="60" CssClass="forminput" />
   </div>
    <div class="settingrow">
        <mp:SiteLabel id="SiteLabel6" runat="server" ForControl="ddNewControlType" ConfigKey="ModuleDefinitionsSettingControlTypeLabel" CssClass="settinglabel"></mp:SiteLabel>
    ...
    <div class="settingrow">
        <mp:SiteLabel id="SiteLabel7" runat="server" ForControl="txtNewControlSrc" ConfigKey="ModuleDefinitionsSettingControlSrcLabel" CssClass="settinglabel"></mp:SiteLabel>
        <asp:TextBox ID="txtNewControlSrc" runat="server" MaxLength="255" Columns="60" CssClass="forminput" />
    </div>
     <div class="settingrow">
        <mp:SiteLabel id="SiteLabel77" runat="server" ForControl="txtNewSettingValue" ConfigKey="ModuleDefinitionsSettingValueLabel" CssClass="settinglabel"></mp:SiteLabel>
        <asp:TextBox ID="txtNewSettingValue" runat="server" MaxLength="255" Columns="60" CssClass="forminput" />
    </div>
    <div class="settingrow">
        <mp:SiteLabel id="SiteLabel11" runat="server" ForControl="txtNewSortOrder" ConfigKey="ModuleDefinitionsSettingSortOrderLabel" CssClass="settinglabel"></mp:SiteLabel>
        <asp:TextBox ID="txtNewSortOrder" runat="server" Text="500" MaxLength="255" Columns="60" CssClass="forminput" />
    </div>
    <div class="settingrow">
        <mp:SiteLabel id="SiteLabel13" runat="server" ForControl="txtNewHelpKey" ConfigKey="ModuleDefinitionsSettingHelpKeyLabel" CssClass="settinglabel"></mp:SiteLabel>
        <asp:TextBox ID="txtNewHelpKey" runat="server" MaxLength="255" Columns="60" CssClass="forminput" />
    </div>
     <div class="settingrow">
            <mp:SiteLabel id="SiteLabel8" runat="server" ForControl="txtNewRegexValidationExpression" ConfigKey="ModuleDefinitionsSettingRegexExpressionLabel" CssClass="settinglabel"></mp:SiteLabel>
