...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
    ...
    <asp:Panel ID="pnlSetting" runat="server" CssClass="panelwrapper admin pagesettings">
        <div class="modulecontent">
            <fieldset class="pagesettings">
                <legend>
                    <mp:SiteLabel ID="lblPageNameLayout" runat="server" ConfigKey="PageSettingsLabel">
                    </mp:SiteLabel>
