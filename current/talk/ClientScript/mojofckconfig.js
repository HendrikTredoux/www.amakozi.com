...
//FCKConfig.PluginsPath = '/ClientScript/FCKeditormojoplugins' ;
//FCKConfig.Plugins.Add( 'mojoimagedialog', 'en' ) ;
...
FCKConfig.ToolbarSets["BasicOld"] = [
...
FCKConfig.ToolbarSets["Basic"] = [
	['Blockquote','Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','-','About']
] ;
...
FCKConfig.ToolbarSets["Full"] = [
	['Source'],
	['SelectAll', 'RemoveFormat', 'Cut', 'Copy', 'Paste', 'PasteText', 'PasteWord', '-', 'Print', 'SpellCheck'],
...
FCKConfig.ToolbarSets["SimpleWithSource"] = [
    ['Source','Cut','Copy','PasteText'],
	['Blockquote','Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','SpellCheck','Smiley']
] ;
...
FCKConfig.SpellChecker = 'SCAYT'; // 'WSC' | 'SpellerPages' | 'ieSpell'  | 'SCAYT'
...
// keep mathml form being altered
FCKConfig.ProtectedSource.Add( /<math[\s\S]*?<\/math>/g ) ;


// This will be applied to the body element of the editor
FCKConfig.BodyId = '' ;
FCKConfig.BodyClass = 'wysiwygeditor';
...
FCKConfig.LinkUploadDeniedExtensions	= ".(config|html|htm|php|php2|php3|php4|php5|phtml|pwml|inc|asp|aspx|ascx|jsp|cfm|cfc|pl|bat|exe|com|dll|vbs|js|reg|cgi|htaccess|asis|sh|shtml|shtm|phtm)$" ;	// empty for no one
...
FCKConfig.SmileyPath	= '/Data/SiteImages/emoticons/' ;
