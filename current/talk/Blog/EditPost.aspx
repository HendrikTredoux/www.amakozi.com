...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
    ...
    <asp:Panel ID="pnlBlog" runat="server" DefaultButton="btnUpdate" CssClass="panelwrapper editpage blogedit">
        <div class="modulecontent">
            <fieldset>
                <legend>
                    <mp:SiteLabel ID="lblBlogEntry" runat="server" ConfigKey="BlogEditEntryLabel" ResourceFile="BlogResources"
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <div class="settingrow blogeditcategories">
                                                <asp:CheckBoxList ID="chkCategories" runat="server" EnableTheming="false" 
