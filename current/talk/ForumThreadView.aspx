<%@ Page Language="C#" ClassName="OldForumThreadView.aspx" Inherits="System.Web.UI.Page"   %>
...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("Location", siteRoot + "/Forums/Thread.aspx?pageid=" 
...
<head id="Head1" runat="server">
    <title>ForumThreadView</title> 
</head>
<body>
 <form id="form1" runat="server">
<h1>ForumThreadView</h1>
</form>
</body>
</html>
