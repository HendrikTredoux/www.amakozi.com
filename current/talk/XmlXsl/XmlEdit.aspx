    ...
    <asp:panel id="pnlWrapper" runat="server" cssclass="panelwrapper xmlmodule">
        <div class="modulecontent">
            <fieldset class="xmledit">
                <legend>
                    <mp:SiteLabel ID="lblSettings" runat="server" ConfigKey="EditXmlSettingsLabel" ResourceFile="XmlResources"
                ...
                <asp:panel id="pnlEdit" runat="server" cssclass="modulecontent" defaultbutton="updateButton">
                    ...
                    <div class="settingrow">
                        <mp:SiteLabel ID="Sitelabel3" runat="server" ForControl="fileToUpload" CssClass="settinglabel"
                            ConfigKey="UploadXmlXsl" ResourceFile="XmlResources"></mp:SiteLabel>
                        <div class="forminput">
                            <NeatUpload:InputFile ID="fileToUpload" Size="50" runat="server" />
                    ...
                    <div class="settingrow">
                        ...
                        <div class="forminput">
                            ...
                            <asp:regularexpressionvalidator id="regexFile" controltovalidate="fileToUpload" validationexpression="(([^.;]*[.])+(xml|xsl|XML|XSL); *)*(([^.;]*[.])+(xml|xsl|XML|XSL))?$"
