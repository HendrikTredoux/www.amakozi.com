<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="FileDialog.aspx.cs"
    Inherits="mojoPortal.Web.Dialog.FileDialog" %>
        ...
        <tr>
            <td colspan="2" style="background-color: #F0EFF1;" valign="top" align="right">
                <div style="font-size: x-small">
                        ...
                        <mp:SiteLabel ID="SiteLabel3" ForControl="txtMaxWidth" runat="server" ConfigKey="FileBrowserMaxHeight" EnableViewState="false" CssClass="boldtext"></mp:SiteLabel>
