...
<asp:panel id="pnlForumList" runat="server" CssClass="forumlist">
    <asp:repeater id="rptForums" runat="server">
        <HeaderTemplate><ul class="simplelist forumlist"></ul></HeaderTemplate>
        <itemtemplate>
         <li class="forumwrap">
            <div class="ftitle"> 
            ...
            <div  id="divSubscribed" runat="server" enableviewstate="false" class="fsubscribe" Visible='<%# Request.IsAuthenticated %>' > 
      ...
      <alternatingitemtemplate>
		<li class="forumwrap forumwrapalt">
           ...
           <div id="divSubscribedAlt" runat="server" enableviewstate="false" class="fsubscribe" Visible='<%# Request.IsAuthenticated %>'>  
