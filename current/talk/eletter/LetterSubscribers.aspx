...
<asp:Panel ID="pnlBatchProcessSubscribers" runat="server" Visible="false">
<asp:FileUpload runat="server" ID="fileBatchProcessSubscribers" />
<portal:mojoButton runat="server" ID="btnBatchProcessSubscribers" Text="Batch Process Subscribers" />
