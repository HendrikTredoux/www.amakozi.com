...
<div id="divEmailInput" runat="server" class="settingrow">
    ...
    <asp:RegularExpressionValidator ID="regexEmail" runat="server" ControlToValidate="txtEmail" ValidationGroup="profile" Display="Dynamic"></asp:RegularExpressionValidator> 
</div>
